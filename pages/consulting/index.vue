    ...
    <section class="container">
        ...
        <div class="row">
          <u-animate-container>
            <u-animate
              ...
              :begin="false"
              class="col-xs-12 col-md-4 wow fadeInRight ">
            ...
            <u-animate
              ...
              animateClass="animated"
              :begin="false"
              class="col-xs-12 col-md-8 wow fadeInDown">
              ...
              <div class="about-text">
                ...
                <p v-for="(consulting,index) in most_consultings">
                  {{ consulting.question }}
      ...
      <div class="row">
        <div class="col-xs-12 col-md-8 col-lg-9">
          ...
          <nuxt-link :to="localePath('/consulting/all')" class="btn btn-more form-control margin-10">{{ $t('more') }}</nuxt-link>
        </div>
