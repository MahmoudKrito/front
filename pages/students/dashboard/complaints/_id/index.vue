            ...
            <div class="main-content">
              <div class="content-side">
                ...
                <div class="section-wrapper section-custom">
                    ...
                    <div class="col-xs-12 col-lg-10 col-lg-push-1">
                      <div class="complaint-info">
                        ...
                        <div>
                          ...
                          <div>{{ complaint.created_at | formatDateByDay }} {{complaint.created_at |formatDateByMonth}} {{ complaint.created_at | formatDateByYear }}
                          </div>
                        ...
                        <div class="col-xs-12 col-lg-10 col-lg-push-1">
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-9">
                              ...
                              <textarea class="form-control" name="" rows="6" placeholder="Leave your reply here..."
                                ...
                                <div class="form-group text-right">
                                  <button type="submit" class="btn btn-primary"
                                          @click.prevent="validateForm">{{$t('add')}}
                                  </button>
                                </div>
                              </form>
                            </div>
                  ...
                  <div class="section-footer" v-if="messages.length > 0">
                    <div class="row">
                      <div class="col-xs-12 col-lg-10 col-lg-push-1">
...
export default {
  ...
  methods: {
    getComplaint() {
      this.$axios.$get('/student/complaints/' + this.complaint_id + '/show')
        .then(response => {
    ...
    addReply() {
      this.$axios.$post('/student/complaints/reply', {
    ...
    addReview(e) {
      if (!this.rating) {
        ...
        this.$axios.$post('/student/complaints/' + this.complaint_id + '/rating', {
          rating: this.rating
        })
          .then(response => {
            this.complaint = response.data;
