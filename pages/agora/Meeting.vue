...
export default {
  ...
  data() {
    return {
      videoProfile: this.$cookies.get("videoProfile").split(",")[0] || "480p_4",
      channel: this.$cookies.get("channel") || "test",
      transcode: this.$cookies.get("transcode") || "interop",
      attendeeMode: this.$cookies.get("attendeeMode") || "video",
      baseMode: this.$cookies.get("baseMode") || "avc",
      uid: undefined
    };
  },
  mounted() {
