...
export default {
  layout: 'default',
  components: {
    BaseOptions: () => import("~/components/agora/BaseOptions"),
    AdvancedOptions: () => import("~/components/agora/AdvancedOptions"),
    InputChannel: () => import("~/components/agora/InputChannel")
  },
  ...
  methods: {
    ...
    handleJoin() {
      ...
      this.$cookies.set("channel", this.channel);
      this.$cookies.set("baseMode", this.baseMode);
      this.$cookies.set("transcode", this.transcode);
      this.$cookies.set("attendeeMode", this.attendeeMode);
      this.$cookies.set("videoProfile", this.videoProfile);
      this.$router.push("/agora/meeting");
    }
  },
