  ...
  methods: {
    ...
    handleExit(e) {
      ...
      try {
        ...
        this.$axios.get('/doctors/sessions/' + this.$route.params.slug + '/updateIsDoneStatus')
          .then(response => {
        ...
        if (this.user.user_type_id == 5) {
          ...
          this.$router.push(this.localePath('/doctors/dashboard/sessions/' + this.$route.params.slug + '/session-add-report'));
        }else if(this.user.user_type_id == 3){
          this.$router.push(this.localePath('/students/dashboard/sessions/' + this.$route.params.slug + '/report'));
        }
