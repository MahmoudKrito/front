...
<!--                            {{ notification.body }}-->
<!--                          </div>-->
<!--                          <div class="notification-time">{{ notification.created_at |formatDateByDay }}-->
...
<!--                   aria-haspopup="true"-->
<!--                   aria-expanded="false">-->
<!--                                <span style="width:30px;height:30px;margin-top:5px">-->
...
<!--                  </li>-->
<!--&lt;!&ndash;                  <li>&ndash;&gt;-->
<!--&lt;!&ndash;                    <nuxt-link :to="switchLocalePath('en')">&ndash;&gt;-->
<!--&lt;!&ndash;                      <i class="fa fa-sign-out"></i>&ndash;&gt;-->
<!--&lt;!&ndash;                      English&ndash;&gt;-->
...
<!--              </li>-->
            ...
            <form class="navbar-form navbar-right">
              <label class="switch-mode" @click="changeMode()">
                <input type="checkbox">
  ...
  export default {
    ...
    methods: {
      ...
      async logout(e) {
        ...
        e.preventDefault();
        localStorage.setItem('doctor_log', true);
        this.$router.push('/')
      },
